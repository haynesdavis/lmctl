...
BRENT_VELOCLOUD_DIR = 'velocloud'
BRENT_VELOCLOUD_SCRIPTS_DIR = 'template'
BRENT_VELOCLOUD_EDGE_PROVISION_REQUEST_FILE= 'EdgeProvision.json'
BRENT_VELOCLOUD_DELETE_EDGE_REQUEST_FILE = 'DeleteEdge.json'
BRENT_VIPTELA_DIR = 'viptela'
BRENT_VIPTELA_SCRIPTS_DIR = 'template'
BRENT_VIPTELA_ATTACH_DEVICE_REQUEST_FILE = 'AttachDevice.json'
